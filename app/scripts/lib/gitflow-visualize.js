        ...
        (function () {
            ...
            var combineColumnsOfType = function (type) {
                ...
                for (var i = 0; i < groups.length; i++) {
                    ...
                    ///////  THIS 'ii' crap was me changing stuff.  It was just 'i' before //////////
                    for (var ii = 0; ii < columnsToCombine.length; ii++) {
                        var column = columnsToCombine[ii];
                        for (var j = 0; j < ii; j++) {
                    ...
                    labelData
                        ...
                        .html(function (d) {
                            ...
                            if (d.authorTimestamp) {
                                ...
                                // if (today) {
                                //     res += "<td class='date'>" + moment().calendar(dt) + "</td> ";
                                // } else {
                                //     res += "<td class='date' title='" + moment().calendar(dt); + "'>" +  moment().calendar(dt); + "</td> ";
                                // }
                            }
            ...
            if (document) {
                $(function () {
                    var style =
                                    ...
                                    '.msg {text-overflow: ellipsis;}' +
                                    '.commits-graph{}.messages{position:relative;}' +
                                    '.commit-msg{position:absolute;white-space:nowrap;cursor:pointer;padding-left:25%;width:100%;overflow-x:hidden;}' +
                                    ...
                                    '.commit-table{width:100%;table-layout:fixed;}td.author{width:10em;}td.sha{display: none;}td.date{width:10em;}' +
